...
public class generateCode extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ruThere.generateCode((String)session.getAttribute("email"), (String)request.getParameter("sheetName"))) {
			ruThere.generateCoord((String)session.getAttribute("email"), 
								(String)request.getParameter("sheetName"),
								(String)request.getParameter("coordLat"),
								(String)request.getParameter("coordLng"));
